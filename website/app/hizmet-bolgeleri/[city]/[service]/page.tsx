...
export default async function ServiceRegionServicePage({
  ...
  const serviceContent = findServiceContentBySlug(serviceItem.slug);
  const whoIsItFor =
    serviceContent?.whoIsItFor ?? [`${location.title} bölgesindeki ailelerin ihtiyaç analizi sonrasında önerilir.`];
          ...
          <div className="grid gap-8 lg:grid-cols-[1fr_0.92fr] lg:items-center">
            <div className="surface rounded-[32px] p-8 lg:p-10">
              <div className="mb-4 flex flex-wrap items-center gap-2 text-xs text-muted">
                ...
                <span>/</span>
                <Link href="/hizmet-bolgeleri" className="hover:text-green transition-colors">Türkiye Geneli Hizmet</Link>
                <span>/</span>
                <Link href={`/hizmet-bolgeleri/${location.slug}`} className="hover:text-green transition-colors">{location.title}</Link>
                <span>/</span>
                <span className="font-medium text-ink">{serviceItem.title}</span>
              </div>

              <SectionLabel>Şehir + Hizmet</SectionLabel>
              ...
              <p className="mt-4 max-w-2xl text-sm leading-7 text-muted">
                Bu sayfa, {location.title} aramasını kolaylaştırmak için hazırlandı. Dadı Kapıda aynı hizmet için Türkiye genelinde talep alır.
              </p>
            ...
            <div className="surface rounded-[32px] p-6 lg:p-8">
              <SectionHeading
                title="Kısa özet"
                subtitle="Hangi şehirde olursanız olun, değerlendirme yaklaşımı aynı kurumsal yapı ile ilerler."
              />
              <div className="mt-6 space-y-3">
                <div className="rounded-2xl border border-line bg-bg p-4">
                  <p className="text-xs font-semibold uppercase tracking-[0.16em] text-gold">Şehir</p>
                  <p className="mt-1 text-sm font-medium text-ink">{location.title}</p>
                </div>
                <div className="rounded-2xl border border-line bg-bg p-4">
                  <p className="text-xs font-semibold uppercase tracking-[0.16em] text-gold">Hizmet</p>
                  <p className="mt-1 text-sm font-medium text-ink">{serviceItem.title}</p>
                </div>
                <div className="rounded-2xl border border-line bg-bg p-4">
        ...
        <div className="mx-auto max-w-7xl px-5 lg:px-8">
          <div className="grid gap-5 lg:grid-cols-3">
            <div className="surface rounded-[28px] p-6">
              ...
              <h2 className="mt-3 font-heading text-2xl font-semibold text-ink">Bu hizmet hangi ailelere uygun?</h2>
            ...
            <div className="surface rounded-[28px] p-6">
              ...
              <h2 className="mt-3 font-heading text-2xl font-semibold text-ink">Adaylarda neyi kontrol ediyoruz?</h2>
              <div className="mt-4 space-y-3">
            ...
            <div className="surface rounded-[28px] p-6">
              <SectionLabel>Aday Profili</SectionLabel>
              <h2 className="mt-3 font-heading text-2xl font-semibold text-ink">Aradığımız temel nitelikler</h2>
              <div className="mt-4 space-y-3">
        ...
        <section className="border-t border-line bg-white py-16 lg:py-24">
          <div className="mx-auto max-w-4xl px-5 lg:px-8">
            <SectionHeading
              ...
              subtitle={`${location.title} ve ${serviceItem.title.toLowerCase()} için en çok sorulan birkaç soruyu aşağıda topladık.`}
            />
            <div className="mt-6">
      ...
      <section className="bg-white py-16 lg:py-20">
        <div className="mx-auto max-w-7xl px-5 lg:px-8">
          <div className="grid gap-5 lg:grid-cols-[1fr_0.92fr]">
            <div className="surface rounded-[28px] p-6">
              <SectionLabel>Aynı Hizmetin Diğer Şehirleri</SectionLabel>
              <h2 className="mt-3 font-heading text-2xl font-semibold text-ink">Bu hizmeti başka şehirlerde de görün</h2>
            ...
            <div className="surface rounded-[28px] p-6">
              ...
              <h2 className="mt-3 font-heading text-2xl font-semibold text-ink">Başvuruyu şimdi bırakalım</h2>
              <p className="mt-3 text-sm leading-7 text-muted">
                Hizmet tipi net değilse bile sorun değil. Aile başvurusu ile şehir, bütçe ve çalışma düzenini bize bırakın; danışman ekibimiz yönlendirsin.
              </p>
